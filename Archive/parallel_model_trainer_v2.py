...
class ParallelModelTrainer:
    ...
    def _train_model(
        ...
        model, eval_history = self.model_adapter.fit(model, X_train_scaled, y_train, X_val_scaled, y_val)
    ...
    def process_fold(self, fold_idx: int, train_idx: np.ndarray, val_idx: np.ndarray) -> FoldResult:
        ...
        model, eval_history = self._train_model(X_train_scaled, y_train, X_val_scaled, y_val)
