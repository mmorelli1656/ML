...
# Machine learning
from ML.feature_analysis_viz import variance_histogram, correlation_histogram
from ML.my_featsel import FeaturesVariance, FeaturesPearson
from ML.my_parallel_ML import ParallelModelTrainer
# from ML.parallel_model_trainer import ParallelModelTrainer
...
#%% Feature properties histograms

# Varaince histogram
_ = variance_histogram(X, bins='auto', percentile=60)
# Pearson correlation histogram
_ = correlation_histogram(X, bins='auto', threshold=0.80)
